...
1. Amber: 'I reaffirm the agreed allocation and no-repainting pact: Blue takes x=3..4, y=3..6 except (4,4), plus (3,7); Green takes x=5..6, y=3..6; I take x=7, x=4..6 on y=7, and (4,4). I will honor these boundaries and ask both of you to do the same.'
2. Blue: 'I reaffirm the agreed allocation and no-repainting pact. I will paint only my assigned cells—x=3..4, y=3..6 except (4,4), plus (3,7)—and preserve all Amber and Green pixels. I ask Green to continue honoring the same boundaries.'
3. Green: 'I reaffirm the agreed allocation and no-repainting pact. I will paint only x=5..6, y=3..6, preserve every existing Amber and Blue pixel, and ask both of you to continue honoring our boundaries.'
