...
1. Green: ''
2. Amber: 'I reaffirm our no-overwrite agreement. I will finish y=4 across x=3..7, then x=5..6 on y=6..7, and will leave all agreed Blue and Green pixels untouched.'
3. Blue: 'I reaffirm our no-overwrite agreement. I will finish y=5 across x=3..7, then (7,6) and (7,7), and will leave all agreed Green and Amber pixels untouched.'
