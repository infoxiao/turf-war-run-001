...
1. Amber: 'I propose a fixed fair split of x=3..7, y=3..7: I take cells where (x+y) mod 3 = 0, Blue takes remainder 1, and Green takes remainder 2. That gives 8/9/8 cells, assigns (3,3) to me and (7,7) to Green, and compensates Blue with the extra\xa07.5'
